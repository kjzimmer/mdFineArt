...
- Admin left-nav shell with tabs: Works, Inbox, People, Orders, Analytics, Configuration always shown; Commissions, Blog, Newsletter, Events, Classes each gated behind their own Site Features enabled toggle (all six Site Features nav-tab toggles now wired the same way — no exceptions)
