...
export function LibraryAssetPicker({ onClose, onAttach }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-6">
      <div className="flex max-h-[85vh] w-full max-w-3xl flex-col gap-4 rounded-2xl bg-bg p-6">
            ...
            {assets.map((asset) => {
              ...
              return (
                <button
                  ...
                  className={`aspect-square overflow-hidden rounded-md ring-2 transition ${isSelected ? 'ring-accent' : 'ring-transparent'}`}
                >
